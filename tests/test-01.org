...
4. Create an array of integers of size $10$ named values.  Initialize
   ...
   ~main()~ function.  In your main function, write a loop that
   displays the contents of the array after calling your ~initNegative~
...
An eCollege dropbox has been created for this test.  You should
upload your version of the test by the end of test time to the eCollege
dropbox named ~Test 01~.  Work submitted by the end
