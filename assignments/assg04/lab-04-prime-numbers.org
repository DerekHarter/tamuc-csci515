...
will take 2 integer parameters as input, the ~minRange~ and
~maxRange~ of the range that the function should search
...
that all of your functions (~main~, ~findPrimes~, ~isPrime~)
