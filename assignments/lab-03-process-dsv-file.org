...
1. Your program must successfully open the file from the current
  working directory. 10 or more points.
1. Your program must successfully read the lines from the file in the
  correct order and attempt to process them. 20 points.
1. Your program must use I/O manipulators to achieve the correct output
  format of the cleaned up original data.  30 or more points.
1. Your program must include a header for the original data, properly
  formatted. 10 points.
1. Your program must produce the correct summary information values. 30
  or more points.
1. Your program must format the summary information as required, again
