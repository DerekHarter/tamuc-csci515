...
- Your program must use I/O manipulators to achieve the correct output
  format of the cleaned up original data.  20 or more points.
- Your program must include the header of the original data, properly
  formatted. 10 points.
- Your program must produce the correct summary information. 10 or more points.
- Your program must format the summary information as required.  10 or more points.

** Program Style

- Your program must conform to all required style/formatting
  guidelines for this week.  Each guideline that is not being followed
  will remove 33 points from total.
