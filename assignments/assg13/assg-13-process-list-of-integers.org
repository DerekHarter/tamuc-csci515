...
2. Implement a function called ~concatenateLists()~.  This function
...
3. Implement a function called ~reverseList()~.  This function will
   ...
   new list as the result of calling this function.  
